...
export default function ForgotPasswordPage() {
    ...
    if (success) {
        return (
            <AuthShell gridSize={15} glowClassName="w-[500px] h-[500px] bg-green-500/20" cardClassName="text-center">
    ...
    return (
        <AuthShell glowClassName="w-[600px] h-[600px] bg-blue-600/10 blur-[130px]">
